...
class MainClient extends core_1.BaseClient {
    ...
    prepareEvent(event, scope, hint) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const prepared = yield _super("prepareEvent").call(this, event, scope, hint);
            return prepared ? normalize_1.normalizeEvent(yield context_1.addEventDefaults(prepared)) : null;
        });
    }
    /**
