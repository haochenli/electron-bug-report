...
function getPackageJson() {
    const packagePath = path_1.join(electron_1.app.getAppPath(), 'package.json');
    return misc_1.dynamicRequire(module, packagePath);
}
...
function getEventDefaults() {
    return __awaiter(this, void 0, void 0, function* () {
        return {
            ...
            release: `${getPackageJson().name}@${electron_1.app.getVersion()}`,
